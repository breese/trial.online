...
void test_any_of()
{
    ...
    circular_span<int> span(array);
    span = { 1, 2, 3, 4 };
    TRIAL_TEST(std::any_of(span.begin(), span.end(), [] (int current) { return current == 1; }));
    span.push_back(5);
    TRIAL_TEST(!std::any_of(span.begin(), span.end(), [] (int current) { return current == 1; }));
}
...
void test_accumulate()
{
    ...
    circular_span<int> span(array);
    span = { 1, 2, 3, 4 };
    TRIAL_TEST_EQ(std::accumulate(span.begin(), span.end(), 0), 1 + 2 + 3 + 4);
    span.push_back(5);
    TRIAL_TEST_EQ(std::accumulate(span.begin(), span.end(), 0), 2 + 3 + 4 + 5);
}
