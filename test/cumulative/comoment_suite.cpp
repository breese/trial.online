...
void test_same_increment_by_half()
{
    ...
    TRIAL_ONLINE_TEST_EQUAL(filter.variance(), 0.0);
    filter.push(1.5, 1.5);
    TRIAL_ONLINE_TEST_WITH(filter.unbiased_variance(), 0.125, tolerance);
    TRIAL_ONLINE_TEST_WITH(filter.variance(), 0.0625, tolerance);
    filter.push(2.0, 2.0);
    TRIAL_ONLINE_TEST_WITH(filter.unbiased_variance(), 0.25, tolerance);
    TRIAL_ONLINE_TEST_WITH(filter.variance(), 0.166667, tolerance);
    filter.push(2.5, 2.5);
    TRIAL_ONLINE_TEST_WITH(filter.unbiased_variance(), 0.416667, tolerance);
    TRIAL_ONLINE_TEST_WITH(filter.variance(), 0.3125, tolerance);
    filter.push(3.0, 3.0);
    TRIAL_ONLINE_TEST_WITH(filter.unbiased_variance(), 0.625, tolerance);
    TRIAL_ONLINE_TEST_WITH(filter.variance(), 0.5, tolerance);
}
...
void test_exponential_increase()
{
    ...
    filter.push(1e4, 1e4);
    TRIAL_ONLINE_TEST_WITH(filter.variance(), 1.5264e7, tolerance);
    TRIAL_ONLINE_TEST_WITH(filter.unbiased_variance(), 1.908e7, tolerance);
    filter.push(1e5, 1e5);
    TRIAL_ONLINE_TEST_WITH(filter.variance(), 1.3406e9, tolerance);
    TRIAL_ONLINE_TEST_WITH(filter.unbiased_variance(), 1.6087e9, tolerance);
    filter.push(1e6, 1e6);
    TRIAL_ONLINE_TEST_WITH(filter.variance(), 1.191e11, tolerance);
    TRIAL_ONLINE_TEST_WITH(filter.unbiased_variance(), 1.3896e11, tolerance);
}
...
void test_same()
{
    ...
    cumulative::moment_variance<double> average;
    {
        ...
        average.push(x);
        TRIAL_ONLINE_TEST_CLOSE(filter.unbiased_variance(), average.variance(), tolerance);
    }
    {
        double x = 1.0;
        filter.push(x, x);
