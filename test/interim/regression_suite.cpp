...
void test_linear_increase()
{
    ...
    TRIAL_ONLINE_TEST_CLOSE(filter.slope(), 1.0, tolerance);
    TRIAL_ONLINE_TEST_CLOSE(filter.at(0), 0.0, tolerance);
    TRIAL_ONLINE_TEST_CLOSE(filter.at(6.0), 6.0, tolerance);

    filter.push(7.0, 7.0);
    TRIAL_ONLINE_TEST_CLOSE(filter.slope(), 1.0, tolerance);
    TRIAL_ONLINE_TEST_CLOSE(filter.at(0), 0.0, tolerance);
    TRIAL_ONLINE_TEST_CLOSE(filter.at(7.0), 7.0, tolerance);

    filter.push(8.0, 8.0);
    TRIAL_ONLINE_TEST_CLOSE(filter.slope(), 1.0, tolerance);
    TRIAL_ONLINE_TEST_CLOSE(filter.at(0), 0.0, tolerance);
    TRIAL_ONLINE_TEST_CLOSE(filter.at(8.0), 8.0, tolerance);
}
...
void test_scatter()
{
    ...
    TRIAL_ONLINE_TEST_WITH(filter.slope(), 0.755, tolerance);
    TRIAL_ONLINE_TEST_WITH(filter.at(0.0), -0.535, tolerance);
    TRIAL_ONLINE_TEST_WITH(filter.at(5.0), 3.24, tolerance);

    filter.push(6.0, 4.5);
    TRIAL_ONLINE_TEST_WITH(filter.slope(), 0.818617, tolerance);
    TRIAL_ONLINE_TEST_WITH(filter.at(0.0), -0.762943, tolerance);
    TRIAL_ONLINE_TEST_WITH(filter.at(6.0), 4.14876, tolerance);

    filter.push(7.0, 4.5);
    TRIAL_ONLINE_TEST_WITH(filter.slope(), 0.883696, tolerance);
    TRIAL_ONLINE_TEST_WITH(filter.at(0), -1.35854, tolerance);
    TRIAL_ONLINE_TEST_WITH(filter.at(7.0), 4.82733, tolerance);
}
