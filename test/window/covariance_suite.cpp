...
void test_exponential_increase()
{
    ...
    filter.push(1e4, 1e4);
    TRIAL_ONLINE_TEST_WITH(filter.value(), 1.7538e7, tolerance);
    TRIAL_ONLINE_TEST_WITH(filter.unbiased_value(), 2.3384e7, tolerance);
    filter.push(1e5, 1e5);
    TRIAL_ONLINE_TEST_WITH(filter.value(), 1.7538e9, tolerance);
    TRIAL_ONLINE_TEST_WITH(filter.unbiased_value(), 2.3384e9, tolerance);
    filter.push(1e6, 1e6);
    TRIAL_ONLINE_TEST_WITH(filter.value(), 1.7538e11, tolerance);
    TRIAL_ONLINE_TEST_WITH(filter.unbiased_value(), 2.3384e11, tolerance);
}
