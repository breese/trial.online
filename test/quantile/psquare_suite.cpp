...
void test_quartiles()
{
    ...
    quantile.push(0.02);
    TRIAL_ONLINE_TEST_CLOSE(quantile.value<lower_quartile_ratio>(), 0.02, tolerance); // 0.02
    TRIAL_ONLINE_TEST_CLOSE(quantile.value<median_ratio>(), 0.02, tolerance); // 0.02
    TRIAL_ONLINE_TEST_CLOSE(quantile.value<upper_quartile_ratio>(), 0.02, tolerance); // 0.02
    params = quantile.parameters();
    expected = {
        {1, 0.02}, {2, 0.0}, {3, 0.0},
        {4, 0.0}, {5, 0.0}, {6, 0.0},
    ...
    quantile.push(0.5);
    TRIAL_ONLINE_TEST_CLOSE(quantile.value<lower_quartile_ratio>(), 0.02, tolerance); // 0.02
    TRIAL_ONLINE_TEST_CLOSE(quantile.value<median_ratio>(), 0.02, tolerance); // 0.26
    TRIAL_ONLINE_TEST_CLOSE(quantile.value<upper_quartile_ratio>(), 0.5, tolerance); // 0.5
    params = quantile.parameters();
    expected = {
        {1, 0.02}, {2, 0.5}, {3, 0.0},
        {4, 0.0},  {5, 0.0}, {6, 0.0},
    ...
    quantile.push(0.74);
    TRIAL_ONLINE_TEST_CLOSE(quantile.value<lower_quartile_ratio>(), 0.02, tolerance); // 0.14
    TRIAL_ONLINE_TEST_CLOSE(quantile.value<median_ratio>(), 0.5, tolerance); // 0.5
    TRIAL_ONLINE_TEST_CLOSE(quantile.value<upper_quartile_ratio>(), 0.74, tolerance); // 0.68
    params = quantile.parameters();
    expected = {
        {1, 0.02}, {2, 0.5}, {3, 0.74},
        {4, 0.0}, {5, 0.0}, {6, 0.0},
    ...
    quantile.push(3.39);
    TRIAL_ONLINE_TEST_CLOSE(quantile.value<lower_quartile_ratio>(), 0.02, tolerance); // 0.26
    TRIAL_ONLINE_TEST_CLOSE(quantile.value<median_ratio>(), 0.5, tolerance); // 0.62
    TRIAL_ONLINE_TEST_CLOSE(quantile.value<upper_quartile_ratio>(), 0.74, tolerance); // 2.065
    params = quantile.parameters();
    expected = {
        {1, 0.02}, {2, 0.5}, {3, 0.74},
        {4, 3.39}, {5, 0.0}, {6, 0.0},
    ...
    quantile.push(0.83);
    TRIAL_ONLINE_TEST_CLOSE(quantile.value<lower_quartile_ratio>(), 0.5, tolerance); // 0.38
    TRIAL_ONLINE_TEST_CLOSE(quantile.value<median_ratio>(), 0.74, tolerance); // 0.74
    TRIAL_ONLINE_TEST_CLOSE(quantile.value<upper_quartile_ratio>(), 0.83, tolerance); // 1.47
    params = quantile.parameters();
    expected = {
        {1, 0.02}, {2, 0.5}, {3, 0.74},
        {4, 0.83}, {5, 3.39}, {6, 0.0},
    ...
    quantile.push(22.37);
    TRIAL_ONLINE_TEST_CLOSE(quantile.value<lower_quartile_ratio>(), 0.5, tolerance); // 0.5
    TRIAL_ONLINE_TEST_CLOSE(quantile.value<median_ratio>(), 0.74, tolerance); // 0.785
    TRIAL_ONLINE_TEST_CLOSE(quantile.value<upper_quartile_ratio>(), 3.39, tolerance); // 3.39
    params = quantile.parameters();
    expected = {
        {1, 0.02}, {2, 0.5}, {3, 0.74},
    ...
    quantile.push(10.15);
    TRIAL_ONLINE_TEST_CLOSE(quantile.value<lower_quartile_ratio>(), 0.5, tolerance); // 0.56
    TRIAL_ONLINE_TEST_CLOSE(quantile.value<median_ratio>(), 0.83, tolerance); // 0.83
    TRIAL_ONLINE_TEST_CLOSE(quantile.value<upper_quartile_ratio>(), 10.15, tolerance); // 8.46
    params = quantile.parameters();
    expected = {
        {1, 0.02}, {2, 0.5}, {3, 0.74},
    ...
    quantile.push(15.43);
    TRIAL_ONLINE_TEST_CLOSE(quantile.value<lower_quartile_ratio>(), 0.5, tolerance); // 0.62
    TRIAL_ONLINE_TEST_CLOSE(quantile.value<median_ratio>(), 0.83, tolerance); // 2.11
    TRIAL_ONLINE_TEST_CLOSE(quantile.value<upper_quartile_ratio>(), 10.15, tolerance); // 12.79
    params = quantile.parameters();
    expected = {
        {1, 0.02}, {2, 0.5}, {3, 0.74},
        {4, 0.83}, {5, 3.39}, {6, 10.15},
    ...
    quantile.push(38.62);
    TRIAL_ONLINE_TEST_CLOSE(quantile.value<lower_quartile_ratio>(), 0.74, tolerance); // 0.68
    TRIAL_ONLINE_TEST_CLOSE(quantile.value<median_ratio>(), 3.39, tolerance); // 3.39
    TRIAL_ONLINE_TEST_CLOSE(quantile.value<upper_quartile_ratio>(), 15.43, tolerance); // 17.165
    params = quantile.parameters();
    expected = {
        {1, 0.02}, {2, 0.5}, {3, 0.74},
        {4, 0.83}, {5, 3.39}, {6, 10.15},
    ...
    quantile.push(15.92);
    TRIAL_ONLINE_TEST_CLOSE(quantile.value<lower_quartile_ratio>(), 0.74, tolerance); // 0.74
    TRIAL_ONLINE_TEST_CLOSE(quantile.value<median_ratio>(), 3.39, tolerance); // 6.77
    TRIAL_ONLINE_TEST_CLOSE(quantile.value<upper_quartile_ratio>(), 19.50333, tolerance); // 15.92
    params = quantile.parameters();
    expected = {
        {1, 0.02}, {2, 0.5}, {3, 0.74},
        {4, 0.83}, {5, 3.39}, {6, 10.15},
    ...
    TRIAL_ONLINE_TEST_CLOSE(quantile.value<upper_quartile_ratio>(), 23.9995, tolerance); // 19.145
    expected = {
        {1, 0.02}, {2, 0.5}, {3, 0.74},
    ...
    TRIAL_ONLINE_TEST_CLOSE(quantile.value<upper_quartile_ratio>(), 19.63704, tolerance); // 17.5325
    expected = {
        {1, 0.02}, {2, 0.5}, {3, 0.74},
    ...
    quantile.push(0.4);
    params = quantile.parameters();
    TRIAL_ONLINE_TEST_CLOSE(quantile.value<lower_quartile_ratio>(), 1.21699, tolerance); // 0.74
    TRIAL_ONLINE_TEST_CLOSE(quantile.value<median_ratio>(), 3.75653, tolerance); // 6.77
    TRIAL_ONLINE_TEST_CLOSE(quantile.value<upper_quartile_ratio>(), 16.05907, tolerance); // 15.92
    expected = {
    ...
    quantile.push(0.05);
    params = quantile.parameters();
    TRIAL_ONLINE_TEST_CLOSE(quantile.value<lower_quartile_ratio>(), 0.72432, tolerance); // 0.56
