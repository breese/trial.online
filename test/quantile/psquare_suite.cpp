...
void test_ctor()
{
    quantile::psquare_median<double> filter;
    filter.push(1);
    TRIAL_TEST(!filter.empty());

    // Copy constructor
    quantile::psquare_median<double> copy(filter);
    TRIAL_TEST(!copy.empty());

    // Copy assignment
    quantile::psquare_median<double> assign;
    assign = filter;
    TRIAL_TEST(!assign.empty());

    // Move constructor
    quantile::psquare_median<double> mover(std::move(copy));
    TRIAL_TEST(!mover.empty());

    // Move assignment
    quantile::psquare_median<double> massign;
...
void test_clear()
{
    ...
    quantile.push(3);
    TRIAL_TEST(!quantile.empty());
    TRIAL_TEST_EQ(quantile.value(), 2);
    quantile.clear();
    TRIAL_TEST(quantile.empty());
    TRIAL_TEST_EQ(quantile.value(), 0);
}
...
void test_value()
{
    ...
    TRIAL_TEST_WITH(quantile.value(), quantile.value<quantile::median_ratio>(), tolerance);
    quantile.push(6);
    quantile.push(7);
    quantile.push(8);
    quantile.push(9);
...
void test_get()
{
    ...
    quantile.push(4);
    quantile.push(5);
    TRIAL_TEST_WITH(quantile.get<0>(), 1.0, tolerance);
    TRIAL_TEST_WITH(quantile.get<1>(), 2.0, tolerance);
    TRIAL_TEST_WITH(quantile.get<2>(), 3.0, tolerance);
    TRIAL_TEST_WITH(quantile.get<3>(), 4.0, tolerance);
    TRIAL_TEST_WITH(quantile.get<4>(), 5.0, tolerance);
    TRIAL_TEST_WITH(quantile.get(), quantile.get<2>(), tolerance);
    quantile.push(6);
    quantile.push(7);
    quantile.push(8);
    quantile.push(9);
    quantile.push(10);
    TRIAL_TEST_WITH(quantile.get<0>(), 1.0, tolerance);
    TRIAL_TEST_WITH(quantile.get<1>(), 3.0, tolerance);
    TRIAL_TEST_WITH(quantile.get<2>(), 5.0, tolerance);
    TRIAL_TEST_WITH(quantile.get<3>(), 7.0, tolerance);
    TRIAL_TEST_WITH(quantile.get<4>(), 10.0, tolerance);
}
...
void test_median()
{
    ...
    quantile.push(0.02);
    TRIAL_TEST_WITH(quantile.value(), 0.02, tolerance);
    params = quantile.parameters();
    expected = { {1, 0.02}, {2, 0.0}, {3, 0.0}, {4, 0.0}, {5, 0.0} };
    TRIAL_TEST_ALL_WITH(params.begin(), params.end(), expected.begin(), expected.end(), parameter_tolerance);

    quantile.push(0.5);
    TRIAL_TEST_WITH(quantile.value(), 0.26, tolerance);
    params = quantile.parameters();
    expected = { {1, 0.02}, {2, 0.5}, {3, 0.0}, {4, 0.0}, {5, 0.0} };
    TRIAL_TEST_ALL_WITH(params.begin(), params.end(), expected.begin(), expected.end(), parameter_tolerance);

    quantile.push(0.74);
    TRIAL_TEST_WITH(quantile.value(), 0.5, tolerance);
    params = quantile.parameters();
    expected = { {1, 0.02}, {2, 0.5}, {3, 0.74}, {4, 0.0}, {5, 0.0} };
    TRIAL_TEST_ALL_WITH(params.begin(), params.end(), expected.begin(), expected.end(), parameter_tolerance);

    quantile.push(3.39);
    TRIAL_TEST_WITH(quantile.value(), 0.62, tolerance);
    params = quantile.parameters();
    expected = { {1, 0.02}, {2, 0.5}, {3, 0.74}, {4, 3.39}, {5, 0.0} };
    TRIAL_TEST_ALL_WITH(params.begin(), params.end(), expected.begin(), expected.end(), parameter_tolerance);

    quantile.push(0.83);
    TRIAL_TEST_WITH(quantile.value(), 0.74, tolerance);
    params = quantile.parameters();
    expected = { {1, 0.02}, {2, 0.5}, {3, 0.74}, {4, 0.83}, {5, 3.39} };
    TRIAL_TEST_ALL_WITH(params.begin(), params.end(), expected.begin(), expected.end(), parameter_tolerance);

    quantile.push(22.37);
    TRIAL_TEST_WITH(quantile.value(), 0.74, tolerance); // 0.785
    params = quantile.parameters();
    expected = { {1, 0.02}, {2, 0.5}, {3, 0.74}, {5, 8.04}, {6, 22.37} };
    TRIAL_TEST_ALL_WITH(params.begin(), params.end(), expected.begin(), expected.end(), parameter_tolerance);

    quantile.push(10.15);
    TRIAL_TEST_WITH(quantile.value(), 3.25333, tolerance); // 0.83
    params = quantile.parameters();
    expected = { {1, 0.02}, {2, 0.5}, {4, 3.25333}, {6, 14.41222}, {7, 22.37} };
    TRIAL_TEST_ALL_WITH(params.begin(), params.end(), expected.begin(), expected.end(), parameter_tolerance);

    quantile.push(15.43);
    TRIAL_TEST_WITH(quantile.value(), 7.53148, tolerance); // 2.11
    params = quantile.parameters();
    expected = { {1, 0.02}, {3, 1.57778}, {5, 7.53148}, {7, 19.3584}, {8, 22.37} };
    TRIAL_TEST_ALL_WITH(params.begin(), params.end(), expected.begin(), expected.end(), parameter_tolerance);

    quantile.push(38.62);
    TRIAL_TEST_WITH(quantile.value(), 7.53148, tolerance); // 3.39
    params = quantile.parameters();
    expected = { {1, 0.02}, {3, 1.57778}, {5, 7.53148}, {7, 19.3584}, {9, 38.62} };
    TRIAL_TEST_ALL_WITH(params.begin(), params.end(), expected.begin(), expected.end(), parameter_tolerance);

    quantile.push(15.92);
    TRIAL_TEST_WITH(quantile.value(), 11.2658, tolerance); // 6.77
    params = quantile.parameters();
    expected = { {1, 0.02}, {4, 4.00514}, {6, 11.2658}, {7, 13.91597}, {10, 38.62} };
    TRIAL_TEST_ALL_WITH(params.begin(), params.end(), expected.begin(), expected.end(), parameter_tolerance);

    quantile.push(34.60);
    TRIAL_TEST_WITH(quantile.value(), 11.2658, tolerance); // 10.15
    params = quantile.parameters();
    expected = { {1, 0.02}, {3, 1.75598}, {6, 11.2658}, {8, 17.97648}, {11, 38.62} };
    TRIAL_TEST_ALL_WITH(params.begin(), params.end(), expected.begin(), expected.end(), parameter_tolerance);

    quantile.push(10.28);
    TRIAL_TEST_WITH(quantile.value(), 8.34625, tolerance); // 10.215
    params = quantile.parameters();
    expected = { {1, 0.02}, {4, 3.3787}, {6, 8.34625}, {10, 23.63396}, {12, 38.62} };
    TRIAL_TEST_ALL_WITH(params.begin(), params.end(), expected.begin(), expected.end(), parameter_tolerance);

    quantile.push(1.47);
    TRIAL_TEST_WITH(quantile.value(), 8.34625, tolerance); // 10.15
    params = quantile.parameters();
    expected = { {1, 0.02}, {4, 1.71698}, {7, 8.34625}, {10, 17.97648}, {13, 38.62} };
    TRIAL_TEST_ALL_WITH(params.begin(), params.end(), expected.begin(), expected.end(), parameter_tolerance);

    quantile.push(0.4);
    TRIAL_TEST_WITH(quantile.value(), 5.85354, tolerance); // 6.77
    params = quantile.parameters();
    expected = { {1, 0.02}, {4, 0.527512}, {7, 5.85354}, {10, 13.29556}, {14, 38.62} };
    TRIAL_TEST_ALL_WITH(params.begin(), params.end(), expected.begin(), expected.end(), parameter_tolerance);

    quantile.push(0.05);
    TRIAL_TEST_WITH(quantile.value(), 5.85354, tolerance); // 3.39
    params = quantile.parameters();
...
{
    quantile::psquare<double, quantile::lower_quartile_ratio> quantile;
    const double tolerance_threshold = 1e-5;
    const auto tolerance = detail::close_to<double>(tolerance_threshold);
    auto parameter_tolerance =
        [tolerance_threshold]
    ...
    TRIAL_TEST_WITH(quantile.value(), 0.02, tolerance);
    quantile.push(0.5);
    TRIAL_TEST_WITH(quantile.value(), 0.14, tolerance);
    quantile.push(0.74);
    TRIAL_TEST_WITH(quantile.value(), 0.26, tolerance);
    quantile.push(3.39);
    TRIAL_TEST_WITH(quantile.value(), 0.38, tolerance);
    quantile.push(0.83);
    TRIAL_TEST_WITH(quantile.value(), 0.5, tolerance);
    auto params = quantile.parameters();
    ...
    quantile.push(22.37);
    TRIAL_TEST_WITH(quantile.value(), 0.74, tolerance); // 0.56
    params = quantile.parameters();
    expected = { {1, 0.02}, {2, 0.5}, {3, 0.74}, {5, 8.04}, {6, 22.37} };
    TRIAL_TEST_ALL_WITH(params.begin(), params.end(), expected.begin(), expected.end(), parameter_tolerance);

    quantile.push(10.15);
    TRIAL_TEST_WITH(quantile.value(), 0.74, tolerance); // 0.62
    params = quantile.parameters();
    expected = { {1, 0.02}, {2, 0.5}, {3, 0.74}, {4, 3.51125}, {7, 22.37} };
    TRIAL_TEST_ALL_WITH(params.begin(), params.end(), expected.begin(), expected.end(), parameter_tolerance);

    quantile.push(15.43);
    TRIAL_TEST_WITH(quantile.value(), 0.74, tolerance); // 0.68
    params = quantile.parameters();
    expected = { {1, 0.02}, {2, 0.5}, {3, 0.74}, {5, 7.05987}, {8, 22.37} };
    TRIAL_TEST_ALL_WITH(params.begin(), params.end(), expected.begin(), expected.end(), parameter_tolerance);

    quantile.push(38.62);
    TRIAL_TEST_WITH(quantile.value(), 0.74, tolerance); // 0.74
    params = quantile.parameters();
    expected = { {1, 0.02}, {2, 0.5}, {3, 0.74}, {6, 12.58486}, {9, 38.62} };
    TRIAL_TEST_ALL_WITH(params.begin(), params.end(), expected.begin(), expected.end(), parameter_tolerance);

    quantile.push(15.92);
    TRIAL_TEST_WITH(quantile.value(), 2.83414, tolerance); // 0.7625
    params = quantile.parameters();
    expected = { {1, 0.02}, {2, 0.5}, {4, 2.83414}, {7, 18.27693}, {10, 38.62} };
    TRIAL_TEST_ALL_WITH(params.begin(), params.end(), expected.begin(), expected.end(), parameter_tolerance);

    quantile.push(34.60);
    TRIAL_TEST_WITH(quantile.value(), 2.83414, tolerance); // 0.785
    params = quantile.parameters();
    expected = { {1, 0.02}, {3, 1.43805}, {4, 2.83414}, {8, 23.3892}, {11, 38.62} };
    TRIAL_TEST_ALL_WITH(params.begin(), params.end(), expected.begin(), expected.end(), parameter_tolerance);

    quantile.push(10.28);
    TRIAL_TEST_WITH(quantile.value(), 1.24651, tolerance); // 0.8075
    params = quantile.parameters();
    expected = { {1, 0.02}, {2, 0.5}, {3, 1.24651}, {8, 18.92848}, {12, 38.62} };
    TRIAL_TEST_ALL_WITH(params.begin(), params.end(), expected.begin(), expected.end(), parameter_tolerance);

    quantile.push(1.47);
    TRIAL_TEST_WITH(quantile.value(), 2.62173, tolerance); // 0.83
    params = quantile.parameters();
    expected = { {1, 0.02}, {2, 0.5}, {4, 2.62173}, {8, 14.92867}, {13, 38.62} };
    TRIAL_TEST_ALL_WITH(params.begin(), params.end(), expected.begin(), expected.end(), parameter_tolerance);

    quantile.push(0.4);
    TRIAL_TEST_WITH(quantile.value(), 1.13148, tolerance); // 0.7625
    params = quantile.parameters();
    expected = { {1, 0.02}, {2, 0.054784}, {4, 1.13148}, {10, 18.8754}, {14, 38.62} };
    TRIAL_TEST_ALL_WITH(params.begin(), params.end(), expected.begin(), expected.end(), parameter_tolerance);

    quantile.push(0.05);
    TRIAL_TEST_WITH(quantile.value(), 0.195157, tolerance); // 0.62
    params = quantile.parameters();
...
{
    quantile::psquare<double, quantile::upper_quartile_ratio> quantile;
    const double tolerance_threshold = 1e-5;
    const auto tolerance = detail::close_to<double>(tolerance_threshold);
    auto parameter_tolerance =
        [tolerance_threshold]
    ...
    TRIAL_TEST_WITH(quantile.value(), 0.62, tolerance);
    quantile.push(3.39);
    TRIAL_TEST_WITH(quantile.value(), 1.4025, tolerance);
    quantile.push(0.83);
    TRIAL_TEST_WITH(quantile.value(), 0.83, tolerance);
    auto params = quantile.parameters();
    decltype(params) expected = { {1, 0.02}, {2, 0.5}, {3, 0.74}, {4, 0.83}, {5, 3.39} };
    TRIAL_TEST_ALL_WITH(params.begin(), params.end(), expected.begin(), expected.end(), parameter_tolerance);

    quantile.push(22.37);
    TRIAL_TEST_WITH(quantile.value(), 0.74, tolerance); // 2.75
    params = quantile.parameters();
    expected = { {1, 0.02}, {2, 0.5}, {3, 0.74}, {5, 8.04}, {6, 22.37} };
    TRIAL_TEST_ALL_WITH(params.begin(), params.end(), expected.begin(), expected.end(), parameter_tolerance);

    quantile.push(10.15);
    TRIAL_TEST_WITH(quantile.value(), 3.25333, tolerance); // 6.77
    params = quantile.parameters();
    expected = { {1, 0.02}, {2, 0.5}, {4, 3.25333}, {6, 14.41222}, {7, 22.37} };
    TRIAL_TEST_ALL_WITH(params.begin(), params.end(), expected.begin(), expected.end(), parameter_tolerance);

    quantile.push(15.43);
    TRIAL_TEST_WITH(quantile.value(), 7.531481, tolerance); // 11.47
    params = quantile.parameters();
    expected = { {1, 0.02}, {3, 1.57778}, {5, 7.531481}, {7, 19.3584}, {8, 22.37} };
    TRIAL_TEST_ALL_WITH(params.begin(), params.end(), expected.begin(), expected.end(), parameter_tolerance);

    quantile.push(38.62);
    TRIAL_TEST_WITH(quantile.value(), 12.64923, tolerance); // 15.43
    params = quantile.parameters();
    expected = { {1, 0.02}, {4, 4.005139}, {6, 12.64923}, {8, 28.01532}, {9, 38.62} };
    TRIAL_TEST_ALL_WITH(params.begin(), params.end(), expected.begin(), expected.end(), parameter_tolerance);

    quantile.push(15.92);
    TRIAL_TEST_WITH(quantile.value(), 17.67064, tolerance); // 15.7975
    params = quantile.parameters();
    expected = { {1, 0.02}, {5, 7.72845}, {7, 17.67064}, {8, 21.0322}, {10, 38.62} };
    TRIAL_TEST_ALL_WITH(params.begin(), params.end(), expected.begin(), expected.end(), parameter_tolerance);

    quantile.push(34.60);
    TRIAL_TEST_WITH(quantile.value(), 17.67064, tolerance); // 19.145
    params = quantile.parameters();
    expected = { {1, 0.02}, {4, 4.27935}, {7, 17.67064}, {9, 25.64428}, {11, 38.62} };
    TRIAL_TEST_ALL_WITH(params.begin(), params.end(), expected.begin(), expected.end(), parameter_tolerance);

    quantile.push(10.28);
    TRIAL_TEST_WITH(quantile.value(), 21.58474, tolerance); // 17.5325
    params = quantile.parameters();
    expected = { {1, 0.02}, {5, 6.80087}, {9, 21.58474}, {11, 31.32269}, {12, 38.62} };
    TRIAL_TEST_ALL_WITH(params.begin(), params.end(), expected.begin(), expected.end(), parameter_tolerance);

    quantile.push(1.47);
    TRIAL_TEST_WITH(quantile.value(), 21.58474, tolerance); // 15.92
    params = quantile.parameters();
    expected = { {1, 0.02}, {5, 4.40479}, {10, 21.58474}, {11, 25.64428}, {13, 38.62} };
    TRIAL_TEST_ALL_WITH(params.begin(), params.end(), expected.begin(), expected.end(), parameter_tolerance);

    quantile.push(0.4);
    TRIAL_TEST_WITH(quantile.value(), 17.77648, tolerance); // 15.7975
    params = quantile.parameters();
    expected = { {1, 0.02}, {5, 2.50422}, {10, 17.77648}, {13, 31.49365}, {14, 38.62} };
    TRIAL_TEST_ALL_WITH(params.begin(), params.end(), expected.begin(), expected.end(), parameter_tolerance);

    quantile.push(0.05);
    TRIAL_TEST_WITH(quantile.value(), 21.98825, tolerance); // 15.675
    params = quantile.parameters();
...
void test_quartiles()
{
    ...
    quantile.push(0.02);
    TRIAL_TEST_WITH(quantile.value<quantile::lower_quartile_ratio>(), 0.02, tolerance);
    TRIAL_TEST_WITH(quantile.value<quantile::median_ratio>(), 0.02, tolerance);
    TRIAL_TEST_WITH(quantile.value<quantile::upper_quartile_ratio>(), 0.02, tolerance);
    params = quantile.parameters();
    expected = {
        {1, 0.02}, {2, 0.0}, {3, 0.0},
        {4, 0.0}, {5, 0.0}, {6, 0.0},
    ...
    quantile.push(0.5);
    TRIAL_TEST_WITH(quantile.value<quantile::lower_quartile_ratio>(), 0.14, tolerance);
    TRIAL_TEST_WITH(quantile.value<quantile::median_ratio>(), 0.26, tolerance);
    TRIAL_TEST_WITH(quantile.value<quantile::upper_quartile_ratio>(), 0.38, tolerance);
    params = quantile.parameters();
    expected = {
        {1, 0.02}, {2, 0.5}, {3, 0.0},
        {4, 0.0},  {5, 0.0}, {6, 0.0},
    ...
    quantile.push(0.74);
    TRIAL_TEST_WITH(quantile.value<quantile::lower_quartile_ratio>(), 0.26, tolerance);
    TRIAL_TEST_WITH(quantile.value<quantile::median_ratio>(), 0.5, tolerance);
    TRIAL_TEST_WITH(quantile.value<quantile::upper_quartile_ratio>(), 0.62, tolerance);
    params = quantile.parameters();
    expected = {
        {1, 0.02}, {2, 0.5}, {3, 0.74},
        {4, 0.0}, {5, 0.0}, {6, 0.0},
    ...
    quantile.push(3.39);
    TRIAL_TEST_WITH(quantile.value<quantile::lower_quartile_ratio>(), 0.38, tolerance);
    TRIAL_TEST_WITH(quantile.value<quantile::median_ratio>(), 0.62, tolerance);
    TRIAL_TEST_WITH(quantile.value<quantile::upper_quartile_ratio>(), 1.4025, tolerance);
    params = quantile.parameters();
    expected = {
        {1, 0.02}, {2, 0.5}, {3, 0.74},
        {4, 3.39}, {5, 0.0}, {6, 0.0},
    ...
    quantile.push(0.83);
    TRIAL_TEST_WITH(quantile.value<quantile::lower_quartile_ratio>(), 0.5, tolerance);
    TRIAL_TEST_WITH(quantile.value<quantile::median_ratio>(), 0.74, tolerance);
    TRIAL_TEST_WITH(quantile.value<quantile::upper_quartile_ratio>(), 0.83, tolerance);
    params = quantile.parameters();
    expected = {
        {1, 0.02}, {2, 0.5}, {3, 0.74},
        {4, 0.83}, {5, 3.39}, {6, 0.0},
    ...
    quantile.push(22.37);
    TRIAL_TEST_WITH(quantile.value<quantile::lower_quartile_ratio>(), 0.56, tolerance);
    TRIAL_TEST_WITH(quantile.value<quantile::median_ratio>(), 0.785, tolerance);
    TRIAL_TEST_WITH(quantile.value<quantile::upper_quartile_ratio>(), 2.75, tolerance);
    params = quantile.parameters();
    expected = {
        {1, 0.02}, {2, 0.5}, {3, 0.74},
    ...
    quantile.push(10.15);
    TRIAL_TEST_WITH(quantile.value<quantile::lower_quartile_ratio>(), 0.62, tolerance);
    TRIAL_TEST_WITH(quantile.value<quantile::median_ratio>(), 0.83, tolerance);
    TRIAL_TEST_WITH(quantile.value<quantile::upper_quartile_ratio>(), 6.77, tolerance);
    params = quantile.parameters();
    expected = {
        {1, 0.02}, {2, 0.5}, {3, 0.74},
    ...
    quantile.push(15.43);
    TRIAL_TEST_WITH(quantile.value<quantile::lower_quartile_ratio>(), 0.68, tolerance);
    TRIAL_TEST_WITH(quantile.value<quantile::median_ratio>(), 2.11, tolerance);
    TRIAL_TEST_WITH(quantile.value<quantile::upper_quartile_ratio>(), 11.47, tolerance);
    params = quantile.parameters();
    expected = {
        {1, 0.02}, {2, 0.5}, {3, 0.74},
        {4, 0.83}, {5, 3.39}, {6, 10.15},
    ...
    quantile.push(38.62);
    TRIAL_TEST_WITH(quantile.value<quantile::lower_quartile_ratio>(), 0.74, tolerance);
    TRIAL_TEST_WITH(quantile.value<quantile::median_ratio>(), 3.39, tolerance);
    TRIAL_TEST_WITH(quantile.value<quantile::upper_quartile_ratio>(), 15.43, tolerance);
    params = quantile.parameters();
    expected = {
        {1, 0.02}, {2, 0.5}, {3, 0.74},
        {4, 0.83}, {5, 3.39}, {6, 10.15},
    ...
    quantile.push(15.92);
    TRIAL_TEST_WITH(quantile.value<quantile::lower_quartile_ratio>(), 0.74, tolerance); // 0.7625
    TRIAL_TEST_WITH(quantile.value<quantile::median_ratio>(), 3.39, tolerance); // 6.77
    TRIAL_TEST_WITH(quantile.value<quantile::upper_quartile_ratio>(), 19.50333, tolerance); // 15.7975
    params = quantile.parameters();
    expected = {
        {1, 0.02}, {2, 0.5}, {3, 0.74},
        {4, 0.83}, {5, 3.39}, {6, 10.15},
    ...
    quantile.push(34.60);
    params = quantile.parameters();
    TRIAL_TEST_WITH(quantile.value<quantile::lower_quartile_ratio>(), 0.74, tolerance); // 0.785
    TRIAL_TEST_WITH(quantile.value<quantile::median_ratio>(), 3.39, tolerance); // 10.15
    TRIAL_TEST_WITH(quantile.value<quantile::upper_quartile_ratio>(), 19.50333, tolerance); // 19.145
    expected = {
        {1, 0.02}, {2, 0.5}, {3, 0.74},
    ...
    quantile.push(10.28);
    params = quantile.parameters();
    TRIAL_TEST_WITH(quantile.value<quantile::lower_quartile_ratio>(), 0.74, tolerance); // 0.8075
    TRIAL_TEST_WITH(quantile.value<quantile::median_ratio>(), 6.69185, tolerance); // 10.215
    TRIAL_TEST_WITH(quantile.value<quantile::upper_quartile_ratio>(), 23.9995, tolerance); // 17.5325
    expected = {
        {1, 0.02}, {2, 0.5}, {3, 0.74},
    ...
    quantile.push(1.47);
    params = quantile.parameters();
    TRIAL_TEST_WITH(quantile.value<quantile::lower_quartile_ratio>(), 0.74, tolerance); // 0.83
    TRIAL_TEST_WITH(quantile.value<quantile::median_ratio>(), 6.69185, tolerance); // 10.15
    TRIAL_TEST_WITH(quantile.value<quantile::upper_quartile_ratio>(), 19.63704, tolerance); // 15.92
    expected = {
        {1, 0.02}, {2, 0.5}, {3, 0.74},
    ...
    quantile.push(0.4);
    params = quantile.parameters();
    TRIAL_TEST_WITH(quantile.value<quantile::lower_quartile_ratio>(), 1.21699, tolerance); // 0.7525
    TRIAL_TEST_WITH(quantile.value<quantile::median_ratio>(), 3.75653, tolerance); // 6.77
    TRIAL_TEST_WITH(quantile.value<quantile::upper_quartile_ratio>(), 16.05907, tolerance); // 15.7675
    expected = {
    ...
    quantile.push(0.05);
    params = quantile.parameters();
    TRIAL_TEST_WITH(quantile.value<quantile::lower_quartile_ratio>(), 0.72432, tolerance); // 0.62
    TRIAL_TEST_WITH(quantile.value<quantile::median_ratio>(), 3.75653, tolerance); // 3.39
    TRIAL_TEST_WITH(quantile.value<quantile::upper_quartile_ratio>(), 20.40031, tolerance); // 15.7975
    expected = {
    ...
    TRIAL_TEST_WITH(quantile.value<quantile::minimum_ratio>(), 0.02, tolerance);
    TRIAL_TEST_WITH(quantile.value<quantile::lower_quartile_ratio>(), 0.72432, tolerance);
    TRIAL_TEST_WITH(quantile.value<quantile::median_ratio>(), 3.75653, tolerance);
    TRIAL_TEST_WITH(quantile.value<quantile::upper_quartile_ratio>(), 20.40031, tolerance);
    TRIAL_TEST_WITH(quantile.value<quantile::maximum_ratio>(), 38.62, tolerance);

    TRIAL_TEST_WITH(quantile.get<0>(), quantile.value<quantile::minimum_ratio>(), tolerance);
    TRIAL_TEST_WITH(quantile.get<1>(), quantile.value<quantile::lower_quartile_ratio>(), tolerance);
    TRIAL_TEST_WITH(quantile.get<2>(), quantile.value<quantile::median_ratio>(), tolerance);
    TRIAL_TEST_WITH(quantile.get<3>(), quantile.value<quantile::upper_quartile_ratio>(), tolerance);
    TRIAL_TEST_WITH(quantile.get<4>(), quantile.value<quantile::maximum_ratio>(), tolerance);
    // Defaults
    TRIAL_TEST_WITH(quantile.get(), quantile.value<quantile::median_ratio>(), tolerance);
    TRIAL_TEST_WITH(quantile.get<2>(), quantile.value(), tolerance);
    TRIAL_TEST_WITH(quantile.get(), quantile.value(), tolerance);
}
...
void test_empty()
{
    ...
    TRIAL_TEST_EQ(quantile.value(), 0.0);
}
